...
<div class="kt-grid kt-grid--hor kt-grid--root">
    ...
    Request::route()->getName() === 'GET_EDIT_LESSON_ROUTE') kt-menu__item--submenu kt-menu__item--open kt-menu__item--here @endif"
                            ...
                            data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
                                ...
                                </svg></span><span class="kt-menu__link-text">Khoá học</span>
                                <i
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
                ...
                id="Rectangle-19-Copy-3" fill="#000000"/>
                        ...
                        <li class="kt-menu__item @if(Request::route()->getName() === 'GET_ORDERS_ROUTE' || Request::route()->getName() === 'GET_ORDER_ROUTE') kt-menu__item--active @endif"
                            aria-haspopup="true">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect id="Rectangle-Copy-2" fill="#000000" opacity="0.3"
              ...
              x="16.3255682" y="2.94551858" width="3" height="18" rx="1"/>
                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu @if(
                            Request::route()->getName() === 'GET_NAV_MENU' || Request::route()->getName() === 'GET_ALL_SLIDER' || Request::route()->getName() === 'EDIT_SLIDER' )
                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu @if(
                            Request::route()->getName() === 'GET_FORM_DATA' && Request::route()->getName()==='GET_FORM_DATA')
                                kt-menu__item--submenu kt-menu__item--open kt-menu__item--here @endif"
                            aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                <span class="kt-menu__link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <path d="M11,2 C11,1.44771525 11.4477153,1 12,1 C12.5522847,1 13,1.44771525 13,2 L14.5,2 C14.7761424,2 15,2.22385763 15,2.5 L15,3.5 C15,3.77614237 14.7761424,4 14.5,4 L9.5,4 C9.22385763,4 9,3.77614237 9,3.5 L9,2.5 C9,2.22385763 9.22385763,2 9.5,2 L11,2 Z"
                                                  id="Combined-Shape" fill="#000000"/>
                                            <rect id="Rectangle-152" fill="#000000" opacity="0.3" x="10" y="9" width="7"
                                                  height="2" rx="1"/>
                                            <rect id="Rectangle-152-Copy-2" fill="#000000" opacity="0.3" x="7" y="9"
                                                  width="2" height="2" rx="1"/>
                                            <rect id="Rectangle-152-Copy-3" fill="#000000" opacity="0.3" x="7" y="13"
                                                  width="2" height="2" rx="1"/>
                                            <rect id="Rectangle-152-Copy" fill="#000000" opacity="0.3" x="10" y="13"
                                                  width="7" height="2" rx="1"/>
                                            <rect id="Rectangle-152-Copy-5" fill="#000000" opacity="0.3" x="7" y="17"
                                                  width="2" height="2" rx="1"/>
                                            <rect id="Rectangle-152-Copy-4" fill="#000000" opacity="0.3" x="10" y="17"
                                                  width="7" height="2" rx="1"/>
                                        </g>
                                    </svg>
                                </span>
                            ...
                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                <ul class="kt-menu__subnav">
                                    <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                                class="kt-menu__link"><span
                                                    class="kt-menu__link-text">FORM</span></span></li>
                                    <li class="kt-menu__item @if(Request::url() === route('GET_FORM_DATA', 1)) kt-menu__item--active @endif"
                                        aria-haspopup="true"><a
                                                href="{{ route('GET_FORM_DATA', 1) }}" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                    class="kt-menu__link-text">Form Đăng ký</span></a></li>
                                    <li class="kt-menu__item @if(Request::url() === route('GET_FORM_DATA', 2)) kt-menu__item--active @endif"
                                        aria-haspopup="true"><a
                                                href="{{ route('GET_FORM_DATA', 2) }}" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                    class="kt-menu__link-text">Form Liên hệ</span></a></li>
...
@endif
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect id="Rectangle-7-Copy-2" fill="#000000" opacity="0.3" x="2" y="4" width="5" height="16" rx="1"/>
                                        ...
                                        <li class="kt-menu__item" aria-haspopup="true"><a
                                                    href="{{ route('GET_CREATE_PAGE_ROUTE') }}"
                                                    class="kt-menu__link "><span
                                                        class="kt-menu__link-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect id="Rectangle-7-Copy-2" fill="#000000" opacity="0.3" x="2" y="4" width="5" height="16" rx="1"/>
                                                        ...
                                                        class="kt-menu__link-text">Tất cả bài viết</span></a></li>
                                        <li class="kt-menu__item" aria-haspopup="true"><a
                                                    href="{{ route('GET_CREATE_POST_ROUTE') }}"
                                                    class="kt-menu__link "><span
                                                        class="kt-menu__link-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect id="Rectangle-41-Copy-4" fill="#000000"
              ...
              x="10.5556689" y="9.41281179" width="3.14285714" height="3.14285714" rx="0.75"/>
                                                        ...
                                                        class="kt-menu__link-text">Thư viện</span></a></li>
                                        <li class="kt-menu__item" aria-haspopup="true"><a
                                                    href="{{ route('GET_UPLOAD_NEW_ROUTE') }}"
                                                    class="kt-menu__link "><span
                                                        class="kt-menu__link-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <form>
                                ...
                                <div class="kt-grid-nav kt-grid-nav--skin-light">
                                    <div class="kt-grid-nav__row">
                                        <a href="{{route('GET_ORDERS_ROUTE')}}" class="kt-grid-nav__item">
                                            ...
                                            <span class="kt-grid-nav__title">Quản lý đơn hàng</span>
                                            <span class="kt-grid-nav__desc">Khoá học</span>
                                        </a>
                                        <a href="{{route('GET_OPTION_GENERAL')}}" class="kt-grid-nav__item">
													<span class="kt-grid-nav__icon">
														<svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                             height="24px" viewBox="0 0 24 24" version="1.1"
                                            ...
                                            <span class="kt-grid-nav__desc">Cài đặt tổng quan</span>
                                        </a>
                                    </div>
                                    <div class="kt-grid-nav__row">
                                        <a href="{{route('GET_POSTS_ROUTE')}}" class="kt-grid-nav__item">
													<span class="kt-grid-nav__icon">
														<svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                             height="24px" viewBox="0 0 24 24" version="1.1"
                                            ...
                                            <span class="kt-grid-nav__title">Bài viết</span>
                                            <span class="kt-grid-nav__desc">Quản lý bài viết</span>
                                        </a>
                                        <a href="{{route('GET_ALL_USERS')}}" class="kt-grid-nav__item">
													<span class="kt-grid-nav__icon">
														<svg xmlns="http://www.w3.org/2000/svg"
                                                             xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                             height="24px" viewBox="0 0 24 24" version="1.1"
                                            ...
                                            <span class="kt-grid-nav__title">Khách hàng</span>
                                            <span class="kt-grid-nav__desc">Quản lý thành viên</span>
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                    <div class="kt-subheader__main">
                        ...
                        <span class="kt-subheader__desc">#USER-{{ \Illuminate\Support\Facades\Auth::user()->id }}</span>
                        <a href="{{ route('GET_CREATE_POST_ROUTE') }}"
                           class="btn btn-label-primary btn-bold btn-icon-h kt-margin-l-10">
                            Thêm bài viết
                        </a>
                    </div>
                    <div class="kt-subheader__toolbar">
                        <div class="kt-subheader__wrapper">
                            ...
                            <a href="{{route('GET_UPLOAD_ROUTE')}}" class="btn kt-subheader__btn-primary btn-icon">
                                <i class="flaticon2-file"></i>
                            </a>

                            <a href="{{route('GET_OPTION_GENERAL')}}" class="btn kt-subheader__btn-primary btn-icon">
