                ...
                <div class="form-khkt-home">
                    ...
                    <form action="" class="contact-form-home">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Họ tên:">
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-prepend">
                                <div class="input-group-text"><i class="fa fa-phone" aria-hidden="true"></i></div>
                            </div>
                            <input type="text" class="form-control" id="inlineFormInputGroup" placeholder=" Số điện thoại:   ">
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <input type="text" id="inputPassword6" placeholder="Tên công ty:" class="form-control" aria-describedby="passwordHelpInline">
                        </div>
                        <div class="form-group">
                            <input type="text" id="inputPassword6" placeholder="Chức danh: " class="form-control" aria-describedby="passwordHelpInline">
                        </div>
                        <div class="form-group">
                            <input type="text" id="inputPassword6" placeholder="Địa chỉ: " class="form-control" aria-describedby="passwordHelpInline">
                        </div>
                        <div class="form-group">
                            <select class="form-control">
                                <option value="-1">Khoá học mong muốn: </option>
