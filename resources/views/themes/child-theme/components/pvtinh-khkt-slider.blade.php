                ...
                <div class="form-khkt-home">
                    ...
                    <form action="{{route('ADD_FORM_DATA', 1)}}" class="contact-form-home" method="POST">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" required name="name" class="form-control" id="full_name_contact" placeholder="Họ tên:">
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-prepend">
                                <div class="input-group-text"><i class="fa fa-phone" aria-hidden="true"></i></div>
                            </div>
                            <input type="text" required name="phone" class="form-control" id="phone_contact" placeholder=" Số điện thoại:   ">
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-prepend">
                                <div class="input-group-text"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></div>
                            </div>
                            <input type="text" required name="email" class="form-control" id="email_contact" placeholder="Email:">
                        </div>
