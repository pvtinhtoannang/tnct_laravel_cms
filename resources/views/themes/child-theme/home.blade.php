        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="login-form-tab" data-toggle="pill" href="#login-form"
                           role="tab"
                           aria-controls="pills-home" aria-selected="true">Đăng nhập</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="register-profile-tab" data-toggle="pill" href="#register-profile"
                           role="tab"
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="register-profile" role="tabpanel"
