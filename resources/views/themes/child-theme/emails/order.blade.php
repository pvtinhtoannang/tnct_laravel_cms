                ...
                <table cellpadding="0" cellspacing="0" class="es-header" align="center">
                    ...
                    <tr>
                        <td class="esd-stripe" esd-custom-block-id="1735" align="center">
                            <table class="es-header-body" style="background-color: #fef5e4;" width="600" cellspacing="0"
                                   cellpadding="0" bgcolor="#fef5e4" align="center">
                                <tbody>
                                <tr>
                                    <td class="esd-structure es-p5t es-p5b es-p15r es-p15l" align="left">
                                        ...
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                            <tbody>
                                            <tr>
                                                <td class="es-m-p0r esd-container-frame" width="180" valign="top"
                                                    align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr style="    text-align: center;">
                                                            <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c"
                                                                align="center" style="font-size:0"><a
                                                                        href="https://khoahoc.dailythuegiaminh.com/"
                                                                        target="_blank"><img
                                                                            src="http://dailythuegiaminh.com/wp-content/uploads/2019/06/291a5c2cd8653c3b6574-2-1.png"
                                                                            alt="Petshop logo"
                                                                            title="Đại Lý thuế gia minh" width="50"></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="370" align="left">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-menu" esd-img-prev-h="16"
                                                                esd-img-prev-w="13">
                                                                <table class="es-menu" width="100%" cellspacing="0"
                                                                    ...
                                                                    <tr class="links">
                                                                        <td class="es-p10t es-p10b es-p5r es-p5l"
                                                                            style="padding-bottom: 10px; padding-top: 12px; "
                                                                            width="25.00%" bgcolor="transparent"
                                                                            align="center"><a
                                                                                    style="color: #333333; font-size: 16px;text-decoration: none;"
                                                                                    href="https://khoahocketoan.toannangcantho.com/khoa-hoc">Khoá
                                                                                học</a></td>
                                                                        <td class="es-p10t es-p10b es-p5r es-p5l"
                                                                            style="padding-bottom: 10px; padding-top: 12px; "
                                                                            width="25.00%" bgcolor="transparent"
                                                                            align="center"><a
                                                                                    style="color: #333333; font-size: 16px;text-decoration: none;"
                                                                                    href="https://khoahocketoan.toannangcantho.com/huong-dan">Hướng
                                                                                dẫn</a></td>
                                                                        <td class="es-p10t es-p10b es-p5r es-p5l"
                                                                            style="padding-bottom: 10px; padding-top: 12px; "
                                                                            width="25.00%" bgcolor="transparent"
                                                                            align="center"><a
                                                                                    style="color: #333333; font-size: 16px;text-decoration: none;"
                                                                                    href="https://khoahocketoan.toannangcantho.com/lien-he">Liên
                                                                                hệ</a></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                    ...
                                                    <table style="border-radius: 0px; border-collapse: separate;"
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p15b" align="center">
                                                                <h1>Cảm ơn bạn đã đặt hàng!<br></h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-text es-p5t es-p5b es-p40r es-p40l"
                                                                align="center">
                                                                <p style="color: #333333;">Bạn sẽ nhận được email khi
                                                                    các mặt hàng của bạn được vận chuyển. Nếu bạn có bất
                                                                    kỳ câu hỏi nào, hãy gọi cho chúng tôi theo số 1-
                                                                    800-1234-5678.</p>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="esd-block-button es-p15t es-p10b" align="center">
                                                                <a href="https://tnctcms.dev/tai-khoan"
                                                                   ...
                                                                   style="  font-size: 16px;
                                                                            ...
                                                                            border-radius: 0;
                                                                            background: #15c none repeat scroll 0% 0%;
                                                                            border-color: #15c;
...
">Xem
                ...
                <table class="es-content" cellspacing="0" cellpadding="0" align="center" style="margin-top: 30px">
                    <tbody>
                    <tr>
...
"
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p20t es-p10b es-p20r es-p20l"
                                                                align="left">
                                                                <h4 style="padding: 0 15px;">TỔNG QUAN:</h4>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                ...
                                <tr>
                                    <td class="esd-structure es-p10t es-p10b es-p20r es-p20l"
                                        ...
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                            <tbody>
                                            <tr>
                                                <td class="es-m-p0r es-m-p20b esd-container-frame" width="270"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center;" width="60"><span
                                                                                    style="font-size:13px;"><span
                                                                                        style="line-height: 100%;">Hết hạn</span></span>
                                                                        </td>
                                                                        <td style="text-align: center;" width="100">
                                                                            <span style="font-size:13px;"><span
                                                                                        style="line-height: 100%;">Giá</span></span>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                ...
                                <tr>
                                    <td class="esd-structure es-p20" esd-general-paddings-checked="false" align="left"
                                        ...
                                        <table class="es-left" cellspacing="0" cellpadding="0" align="left"
                                            ...
                                            <tbody>
                                            <tr>
                                                <td class="es-m-p0r es-m-p20b esd-container-frame" width="178"
                                                    valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image es-m-p0l es-m-txt-c" align="left"
                                                                style="font-size:0; text-align: center"><a href
                                                                                                           target="_blank"><img
                                                                            src="http://dailythuegiaminh.com/wp-content/uploads/2019/06/291a5c2cd8653c3b6574-2-1.png"
                                                                            alt="Khoá học kế toán"
                                                                            title="Khoá học kế toán" width="50"
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p5t es-m-txt-c" align="left"
                                                                ...
                                                                <p><a target="_blank" href="tel:123456789">123456789</a><br><a
                                                                            target="_blank" href="mailto:your@mail.com">your@mail.com</a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
